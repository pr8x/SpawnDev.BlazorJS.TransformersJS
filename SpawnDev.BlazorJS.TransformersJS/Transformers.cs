...
namespace SpawnDev.BlazorJS.TransformersJS
{
    ...
    public class Transformers : JSObject
    {
        ...
        /// Downloaded from:<br/>
        /// https://cdn.jsdelivr.net/npm/@huggingface/transformers@3.6.0
        /// </summary>
        public static string LatestBundledVersionSrc { get; } = $"./_content/SpawnDev.BlazorJS.TransformersJS/transformers-3.6.0.js";
        /// <summary>
